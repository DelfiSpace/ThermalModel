...
tcLongSide  = 0.05  / (0.178 * thicknessSolarArray * thermCAl); %1/GL
...
SolverMatrix = addThermalConnection_perso(SolverMatrix, [1 0 -1 0 0 0 0], 1/tcLongSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [1 0 0 -1 0 0 0], 1/tcLongSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [1 0 0 0 -1 0 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [1 0 0 0 0 -1 0], 1/tcShortSide);

% thermal conductance between X- and the other faces
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 1 -1 0 0 0 0], 1/tcLongSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 1 0 -1 0 0 0], 1/tcLongSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 1 0 0 -1 0 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 1 0 0 0 -1 0], 1/tcShortSide);

% thermal conductance between Y+ and the other faces
SolverMatrix = addThermalConnection_perso(SolverMatrix, [-1 0 1 0 0 0 0], 1/tcLongSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 -1 1 0 0 0 0], 1/tcLongSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0  1 0 -1 0 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0  1 0 0 -1 0], 1/tcShortSide);

% thermal conductance between Y- and the other faces
SolverMatrix = addThermalConnection_perso(SolverMatrix, [-1 0 0 1 0 0 0], 1/tcLongSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 -1 0 1 0 0 0], 1/tcLongSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0 0  1 -1 0 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0 0  1 0 -1 0], 1/tcShortSide);

% thermal conductance between Z+, the payload and the other faces
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0 0 0  1 0 -1], 1/payloadR);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [-1 0 0 0 1 0 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 -1 0 0 1 0 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0 -1 0 1 0 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0 0 -1 1 0 0], 1/tcShortSide);
...
% thermal conductance between Z-, the payload and the other faces
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0 0 0 0 1 -1], 1/payloadR);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [-1 0 0 0 0 1 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 -1 0 0 0 1 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0 -1 0 0 1 0], 1/tcShortSide);
SolverMatrix = addThermalConnection_perso(SolverMatrix, [0 0 0 -1 0 1 0], 1/tcShortSide);
